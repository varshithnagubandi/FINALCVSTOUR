...
class tourcap
{
	...
	public void TravellerInfo(int amount)
	{
		...
		System.out.println("COST OF TRAVEL  "+(amount*NoOfPeople));
		System.out.println("10% DISCOUNT ON YOUR FIRST BOOKING");
		System.out.println("COST OF TRAVEL AFTER DISCOUNT "+((amount*NoOfPeople)-(amount*NoOfPeople*0.1)));
